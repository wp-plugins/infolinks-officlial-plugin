...
define('IMG_PATH',$pluginpath.'Bubble.gif');
define('JS_PATH',$pluginpath.'jquery.js');
...
extract($_REQUEST);
		if($_REQUEST['btnSave']=="save configurations"){	
				...
				if($options!="") {				
					 ...
					 update_option('infolinks_jquery',$infolinks_jquery);
					...
					add_option('infolinks_jquery',$infolinks_jquery,$deprecated, $autoload);
				 }	 				 
		}
...
<?php
		...
		//jquery 	
		 $infojquery = get_option('infolinks_jquery');		
			if($infojquery==1){	$jqueryenable = "Checked='checked'"; }
			if($infojquery==0){	$jquerydisble = "Checked='checked'"; }	
    ...
    <tr>
      <td><table width="100%">
          ...
          <tr>
            ...
            <td><input type="radio" name="infolinks_jquery" value="1" <?=$jqueryenable?> />
              Use plugin jQuery <br />
              <input type="radio" name="infolinks_jquery" value="0"  <?=$jquerydisble?> />
              Use site jQuery </td>
          </tr>
          ...
          <tr>
            <td colspan="2"><div style="padding-top:3px;float:left;">
	             <?php
				  $options = get_option('infolinks_status');
				  if($options =="") { ?>
	 				<input type="checkbox" name="infolinks_post"  value="1"  checked="checked" />
				 <?php }  else{  ?>
          ...
          <tr>
            <td colspan="2"><div style="padding-top:3px;float:left;">
                <?php if($options =="") { ?>
				<input type="checkbox" name="infolinks_comments" value="1"  checked="checked"/>
				<?php } else { ?>
